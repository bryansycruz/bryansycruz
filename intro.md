# AI + Nube + Construcción

```{raw} html
<div style="text-align: center; margin: 3rem 0;">
 <p style="font-size: 1.1rem; line-height: 1.6; color: inherit; max-width: 600px; margin: 0 auto 2rem;">
 Hola, soy <strong>Bryan Yamá Cruz</strong> — Arquitecto Constructor de la <strong>Universidad Nacional de Colombia</strong>,
 con fuerte interés en la digitalización del sector de la construcción en Colombia mediante
 <strong>Inteligencia Artificial</strong>, <strong>Machine Learning</strong> y servicios Cloud (<strong>GCP · AWS</strong>).
 </p>

 <p style="font-size: 0.95rem; line-height: 1.6; color: inherit; opacity: 0.75; max-width: 600px; margin: 0 auto 2rem;">
 Este portal documenta la unión entre la <strong>Construcción</strong> y las <strong>Tecnologías de Vanguardia</strong>,
 con el propósito de convertir el conocimiento técnico en herramientas prácticas para la industria.
 </p>

 <div style="display: flex; justify-content: center; gap: 1.8rem; flex-wrap: wrap; margin-top: 2rem;">

 <!-- GitHub -->
 <a href="https://github.com/bryansycruz" target="_blank" rel="noopener noreferrer" title="GitHub"
 ...
 stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" width="28" height="28">
 ...
 <!-- LinkedIn -->
 <a href="https://www.linkedin.com/in/bryanyamacruz/?locale=es" target="_blank" rel="noopener noreferrer" title="LinkedIn"
 style="display: inline-flex; align-items: center; justify-content: center;
 opacity: 0.5; transition: opacity 0.2s, transform 0.2s; text-decoration: none; color: currentColor;"
 onmouseover="this.style.opacity='0.9'; this.style.transform='scale(1.1)';"
 onmouseout="this.style.opacity='0.5'; this.style.transform='scale(1)';">
 ...
 <!-- Correo -->
 <a href="mailto:byama@unal.edu.co" title="byama@unal.edu.co"
 style="display: inline-flex; align-items: center; justify-content: center;
 opacity: 0.5; transition: opacity 0.2s, transform 0.2s; text-decoration: none; color: currentColor;"
 onmouseover="this.style.opacity='0.9'; this.style.transform='scale(1.1)';"
 onmouseout="this.style.opacity='0.5'; this.style.transform='scale(1)';">
...
2. **Clona** el repositorio para ejecutar los notebooks en tu máquina:
 ...
 ```bash
 git clone https://github.com/bryansycruz/bryansycruz.git
 cd bryansycruz
...
Este material es de uso **académico y educativo**. Se distribuye bajo la licencia
[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.es).
Consulta el [aviso legal completo](aviso_legal.md) para más detalles.
